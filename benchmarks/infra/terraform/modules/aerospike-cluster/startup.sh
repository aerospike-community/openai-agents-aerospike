...
DEB_URL="https://download.aerospike.com/artifacts/aerospike-server-enterprise/${VERSION}/aerospike-server-enterprise_${VERSION}-1ubuntu22.04_amd64.deb"
curl -fsSL -o /tmp/aerospike.deb "${DEB_URL}"
apt-get install -y /tmp/aerospike.deb
